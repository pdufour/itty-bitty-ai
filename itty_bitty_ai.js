...
function __wbg_adapter_39(arg0, arg1) {
    const ret = wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8e17856514cd6599_multivalue_shim(arg0, arg1);
    if (ret[1]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('itty_bitty_ai_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
